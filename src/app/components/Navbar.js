            ...
            <div className="relative top-10 flex items-center justify-center z-50">
                <nav className="flex fixed h-14 w-11/12 items-center justify-evenly rounded-2xl bg-slate-800 opacity-95">
                    ...
                    <div className="flex w-[50%] items-center justify-center gap-10">
                        <Link className="text-white transition delay-150 duration-300 ease-in-out hover:-translate-y-1 hover:scale-110" href="/">Financial Tips</Link>
                        <Link className="text-white transition delay-150 duration-300 ease-in-out hover:-translate-y-1 hover:scale-110" href="/technology">About</Link>
                        <Link className="text-white transition delay-150 duration-300 ease-in-out hover:-translate-y-1 hover:scale-110" href="/">Login</Link>
                    </div>
                </nav>
            </div>
        </div>
